import{g as P,d as F,s as B,a as $,b as V}from"./app.min.js";import"./slider.min.js";function N(){const r=document.querySelectorAll("[data-fls-tabs]");let t=[];if(r.length>0){const o=P();o&&o.startsWith("tab-")&&(t=o.replace("tab-","").split("-")),r.forEach((l,d)=>{l.classList.add("--tab-init"),l.setAttribute("data-fls-tabs-index",d),l.addEventListener("click",n),i(l)});let a=F(r,"flsTabs");a&&a.length&&a.forEach(l=>{l.matchMedia.addEventListener("change",function(){e(l.itemsArray,l.matchMedia)}),e(l.itemsArray,l.matchMedia)})}function e(o,a){o.forEach(l=>{l=l.item;let d=l.querySelector("[data-fls-tabs-titles]"),u=l.querySelectorAll("[data-fls-tabs-title]"),g=l.querySelector("[data-fls-tabs-body]"),f=l.querySelectorAll("[data-fls-tabs-item]");u=Array.from(u).filter(c=>c.closest("[data-fls-tabs]")===l),f=Array.from(f).filter(c=>c.closest("[data-fls-tabs]")===l),f.forEach((c,m)=>{a.matches?(g.append(u[m]),g.append(c),l.classList.add("--tab-spoller")):(d.append(u[m]),l.classList.remove("--tab-spoller"))})})}function i(o){let a=o.querySelectorAll("[data-fls-tabs-titles]>*"),l=o.querySelectorAll("[data-fls-tabs-body]>*");const d=o.dataset.flsTabsIndex,u=t[0]==d;if(u){const g=o.querySelector("[data-fls-tabs-titles]>.--tab-active");g&&g.classList.remove("--tab-active")}l.length&&l.forEach((g,f)=>{a[f].setAttribute("data-fls-tabs-title",""),g.setAttribute("data-fls-tabs-item",""),u&&f==t[1]&&a[f].classList.add("--tab-active"),g.hidden=!a[f].classList.contains("--tab-active")})}function s(o){let a=o.querySelectorAll("[data-fls-tabs-title]"),l=o.querySelectorAll("[data-fls-tabs-item]");const d=o.dataset.flsTabsIndex;function u(f){if(f.hasAttribute("data-fls-tabs-animate"))return f.dataset.flsTabsAnimate>0?Number(f.dataset.flsTabsAnimate):500}const g=u(o);if(l.length>0){const f=o.hasAttribute("data-fls-tabs-hash");l=Array.from(l).filter(c=>c.closest("[data-fls-tabs]")===o),a=Array.from(a).filter(c=>c.closest("[data-fls-tabs]")===o),l.forEach((c,m)=>{a[m].classList.contains("--tab-active")?(g?B(c,g):c.hidden=!1,f&&!c.closest(".popup")&&$(`tab-${d}-${m}`)):g?V(c,g):c.hidden=!0})}}function n(o){const a=o.target;if(a.closest("[data-fls-tabs-title]")){const l=a.closest("[data-fls-tabs-title]"),d=l.closest("[data-fls-tabs]");if(!l.classList.contains("--tab-active")&&!d.querySelector(".--slide")){let u=d.querySelectorAll("[data-fls-tabs-title].--tab-active");u.length&&(u=Array.from(u).filter(g=>g.closest("[data-fls-tabs]")===d)),u.length&&u[0].classList.remove("--tab-active"),l.classList.add("--tab-active"),s(d)}o.preventDefault()}}}window.addEventListener("load",N);/*!
