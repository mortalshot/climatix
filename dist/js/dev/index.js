...
function initSliders() {
  ...
  if (document.querySelector(".widget-portfolio")) {
    new Swiper(".widget-portfolio .swiper", {
      modules: [Navigation, Pagination],
      observer: true,
      observeParents: true,
      slidesPerView: 1.1,
      ...
      // Пагинация
      pagination: {
        el: ".widget-portfolio .swiper-pagination",
        clickable: true
      },
      // Кнопки "влево/вправо"
      navigation: {
        prevEl: ".widget-portfolio .swiper-button--prev",
        nextEl: ".widget-portfolio .swiper-button--next"
      },
      // Брейкпоинты
      breakpoints: {
        575: {
  ...
  if (document.querySelector(".widget-blog")) {
    new Swiper(".widget-blog .swiper", {
      modules: [Navigation, Pagination],
      observer: true,
      observeParents: true,
      slidesPerView: 1.1,
      ...
      // Пагинация
      pagination: {
        el: ".widget-blog .swiper-pagination",
        clickable: true
      },
      // Кнопки "влево/вправо"
      navigation: {
        prevEl: ".widget-blog .swiper-button--prev",
        nextEl: ".widget-blog .swiper-button--next"
      },
      // Брейкпоинты
      breakpoints: {
        575: {
    ...
    let partnersInit2 = function() {
      ...
      if (window.innerWidth < 768 && !partnersSlider) {
        partnersSlider = new Swiper(".widget-partners__slider", {
          ...
          // Пагинация
          pagination: {
            el: ".widget-partners__slider .swiper-pagination",
            clickable: true
          },
          // Брейкпоинты
          breakpoints: {
      ...
      } else if (window.innerWidth >= 768 && partnersSlider) {
...
document.addEventListener("click", (e) => {
  ...
  if (isDesktop()) {
    ...
    if (!t.closest(".menu__item_has-children")) {
      document.querySelectorAll(".menu__item_has-children._hover").forEach((li) => li.classList.remove("_hover"));
    }
    return;
  }
  ...
  if (trigger) {
    ...
    if (next) {
      console.log("here");
      slideToggle ? slideToggle(ul) : ul.style.display = "";
    } else {
      console.log("gavno");
      slideToggle ? slideToggle(ul) : ul.setAttribute("hidden", "");
    }
  }
});
function menuInit() {
...
const io = new IntersectionObserver((entries) => {
  ...
  threshold: 0
  // как только любой пиксель футера виден
